...
var openid;
requestByGET("http://www.barcodeapp.cn/wexindeveloper/countMoney/php/get_openid.php",function(res){
	openid = res;
...
function show_ranking_div(){
    ...
    requestByGET("http://www.barcodeapp.cn/wexindeveloper/countMoney/php/get_rankingList.php",function(res){
...
start_game_btn.onclick = function(){
    ...
    requestByGET("http://www.barcodeapp.cn/wexindeveloper/countMoney/php/save_userInfo.php?openid="+openid+"&name="+user_name+"&tel="+user_tel);
	...
	var countNumberTimer = setInterval(function(){
		if (beginCount) {
			if(countNumber > 0){
                ...
                requestByGET("http://www.barcodeapp.cn/wexindeveloper/countMoney/php/update_score.php?openid="+openid+"&score="+number ,function(score){
                	var high_score_span = getElementByID("highScore");
                    high_score_span.innerHTML = score;
                    
                    requestByGET("http://www.barcodeapp.cn/wexindeveloper/countMoney/php/getRanking.php?score="+score ,function(res){
