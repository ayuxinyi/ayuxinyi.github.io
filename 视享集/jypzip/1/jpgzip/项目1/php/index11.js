...
window.onload=function(){
	...
	$("#slider").on("mouseenter",function(){
		...
		if(bb){
			...
			$("#ContactWrap").animate({left:"300px"},500,"easeOutQuad",function(){
	...
	$("#slider").on("mouseleave",function(){
		if(bl){
			bl = false;
			$("#slider").animate({left:"-260px"},100,"easeOutQuad",function(){
				bl = true;
				$("#slider").css({left:"-260px"});
			});
			$("#ContactWrap").animate({left:"40px"},100,"easeOutQuad",function(){
				bl = true;
