...
window.onload=function(){
	...
	$("#slider").on("mouseenter",function(){
		...
		if(bb){
			...
			$("#About-wrap").animate({left:"300px"},500,"easeOutQuad",function(){
				$("#About-wrap").css({left:"300px"});
				bb = true;
			});	
		}	
	});
	$("#slider").on("mouseleave",function(){
		...
		if(bl){
			...
			$("#About-wrap").animate({left:"40px"},500,"easeOutQuad",function(){
				bl = true;
				$("#About-wrap").css({left:"40px"});
